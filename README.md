...
- **Получение информации о пользователе** – обработка валидных и невалидных JWT-токенов.
- **Проверка валидности имен файлов** – тестирование различных форматов имен файлов.
